...
**Acceptance criteria:**
- [x] Chart page labels exist in all current locale files.
- [x] Desktop and mobile layouts follow existing monitoring/Codex page patterns.
- [x] `static/management.html` is updated only by `npm --prefix web run build`.
- [x] All required backend and frontend verification commands pass.

**Verification:**
- [x] Tests pass: `go test ./...`.
- [x] Tests pass: `npm --prefix web test -- src/features/monitoring/charts`.
- [x] Tests pass: `npm --prefix web test -- src/pages/MonitoringChartsPage.test.tsx`.
- [x] Lint passes: `npm --prefix web run lint`.
- [x] Type check passes: `npm --prefix web run type-check`.
- [x] Build passes: `npm --prefix web run build`.
